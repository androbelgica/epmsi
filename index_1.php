                    ...
                    <form class="form-horizontal m-t-20" action="admin/app/login_crud.php" method="POST">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" style="color:white" for="customCheck1">Remember me</label>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-10">
                            <p class="text-center" style="color: white;">Don't have an account? <a href="admin/signup.php" style="color: white;">Sign Up</a></p>
                            </div>
                        </div>
