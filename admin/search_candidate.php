    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Manage Candidates</h4>
                                    ...
                                    <?php foreach ($candidates as $candidate): ?>
                                        <tr>
                                            ...
                                            <a href="edit_candidate.php?id=<?php echo $candidate['candidate_id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <a href="hire.php?id=<?php echo $candidate['candidate_id']; ?>" class="btn btn-sm btn-success">Hire</a>
                                                <form method="POST" action="../admin/app/deletecandidate_crud.php" style="display: inline-block;">
