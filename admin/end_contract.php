...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $emp_status = "Contract Ended";
    $candidate_status = "Contract Ended";
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">End of Contract for <?php echo htmlspecialchars($contract['first_name'] . ' ' . $contract['last_name']); ?>, assigned at <?php echo htmlspecialchars($contract['company_name']); ?> as <?php echo htmlspecialchars($contract['title']); ?></h4>
